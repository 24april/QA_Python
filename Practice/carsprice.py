...
brand_list=("rolls-royce","mercedes","bmw","lexus","lamborghini","land rover","maserati","porsche","jaguar","jeep","bentley","ferrari","cadillac","aston martin","alfa romeo")
...
for x in range(cars_amount):
    ...
    coefbrand=2 if car_brand in brand_list else 1
    ...
    print(f"Стоимость автомобиля №{x+1}:",format(price,'.0f'))
input()
